...
var jfShowPop = function (details) {
    ...
    function clickThought(thishasScrollEle) {
        ...
        var Address = document.getElementById('address_select').getElementsByClassName('address')[0];
        ...
        if(Address){
            ...
            for(var i=0;i<Address.length;i++){
                ...
                Address[i].addEventListener('touchmove',windowBanEvent.Canceling,false);
