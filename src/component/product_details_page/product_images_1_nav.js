...
/*            else {
    ...
    var thisAddress = document.getElementById('address_select').getElementsByClassName('top_address')[0];
   ...
   // thisScrollEle.addEventListener('touchmove', reachEdge, false);
        ...
        for (var i=0;i<thisScrollEle.length;i++){
            ...
            if(thisScrollEle[i].clientHeight < thisScrollEle[i].offsetHeight-4){
                ...
                thisScrollEle[i].addEventListener('touchstart,touchmove',function(e){
